                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <select name="jenis_kemasan" id="jenis_kemasan"
                                    ...
                                    <option value="Toples" {{ old('jenis_kemasan', $kategori->jenis_kemasan) == 'Toples' ? 'selected' : '' }}>Toples</option>
                                    <option value="Pouch" {{ old('jenis_kemasan', $kategori->jenis_kemasan) == 'Pouch' ? 'selected' : '' }}>Pouch</option>
                                </select>
