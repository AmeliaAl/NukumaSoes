        ...
        <div class="w-full max-w-4xl px-6 relative z-10">
            ...
            <div class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[40px] shadow-[0_30px_60px_rgba(0,0,0,0.4)] p-10">
                <div class="mb-10 text-center">
                    <h2 class="text-3xl font-serif font-black text-[#d4af37] drop-shadow-lg uppercase tracking-widest">Tambah Kategori Baru</h2>
                    <p class="text-white/60 text-xs font-bold mt-2 tracking-[0.2em]">PENGELOMPOKKAN MASTER DATA PRODUK</p>
                </div>
