<table>
    <thead>
        ...
        @endphp
        <tr>
            <th colspan="6" style="text-align: center; font-weight: bold; font-size: 18px;">NUKUMA SOES</th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: center; font-weight: bold; font-size: 16px;">BUKU BESAR</th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: center; font-weight: bold; font-size: 14px;">PERIODE: {{ strtoupper($namaPeriode) }}</th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: center; font-weight: bold; font-size: 14px;">NAMA AKUN: {{ strtoupper($namaAkun ?: 'PILIH AKUN') }}</th>
        </tr>
        <tr>
            <th colspan="6"></th>
        </tr>
        <tr>
            ...
            <th rowspan="2" style="font-weight: bold; text-align: center; vertical-align: middle;">SALDO</th>
        </tr>
    </thead>
    <tbody>
        @forelse($entries as $entry)
            @if(isset($entry['is_saldo_akhir']) && $entry['is_saldo_akhir'])
                <tr>
                    ...
                    <td style="background-color: #e5e7eb; color: #000000; font-weight: bold; text-align: right;">{{ $entry['saldo'] }}</td>
                </tr>
            @else
                <tr>
                    ...
                    <td style="text-align: right;">{{ $entry['saldo'] }}</td>
                </tr>
            @endif
        @empty
        <tr>
            <td colspan="5" style="text-align: center;">Tidak ada data buku besar.</td>
        </tr>
        @endforelse
    </tbody>
</table>
