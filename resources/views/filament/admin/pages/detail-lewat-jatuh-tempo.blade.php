    ...
    <x-filament::section>
        @if (empty($rows))
            <p style="text-align:center; color:#9ca3af; padding:2rem 0; font-size:0.875rem;">
                Tidak ada piutang yang melewati jatuh tempo.
            </p>
        @else
            <table style="width:100%; border-collapse:collapse; font-size:0.875rem;">
                <thead>
                    <tr style="border-bottom:2px solid #e5e7eb;">
                        ...
                        <th style="padding:8px 16px; text-align:center; font-size:0.7rem; font-weight:600; color:#9ca3af; text-transform:uppercase; letter-spacing:0.06em;">Terlambat</th>
                ...
                <tbody>
                    @foreach ($rows as $i => $row)
                        ...
                        <tr style="border-bottom:1px solid #f3f4f6;">
                            ...
                            <td style="padding:10px 16px; text-align:center; font-weight:600; color:#dc2626;">
                                {{ \Carbon\Carbon::parse($row->jatuh_tempo)->translatedformat('d/m/Y') }}
                            </td>
                            <td style="padding:10px 16px; text-align:center;">
                                <span style="display:inline-block; padding:2px 10px; border-radius:999px; font-size:0.72rem; font-weight:600; background:#fee2e2; color:#dc2626;">
