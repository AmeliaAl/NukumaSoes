            ...
            <table style="width:100%; border-collapse:collapse; font-size:0.875rem;">
                <thead>
                    <tr style="border-bottom:2px solid #e5e7eb;">
                        ...
                        <th style="padding:8px 16px; text-align:center; font-size:0.7rem; font-weight:600; color:#9ca3af; text-transform:uppercase; letter-spacing:0.06em;">Status</th>
                    ...
                    @foreach ($rows as $i => $row)
                        @php
                            ...
                            $bgStatus = match($status) {
                                'Lewat Jatuh Tempo'      => ['bg' => '#fee2e2', 'color' => '#b91c1c'],
                                'Mendekati Jatuh Tempo'  => ['bg' => '#fef3c7', 'color' => '#b45309'],
                                'Belum Jatuh Tempo'      => ['bg' => '#dcfce7', 'color' => '#15803d'],
                        ...
                        <tr style="border-bottom:1px solid #f3f4f6;">
                            ...
                            <td style="padding:10px 16px; text-align:center; font-weight:600; color:#374151;">
                                {{ $row->jatuh_tempo ? \Carbon\Carbon::parse($row->jatuh_tempo)->translatedFormat('d M Y') : '-' }}
                            </td>
                            <td style="padding:10px 16px; text-align:center;">
                                <span style="display:inline-block; padding:2px 10px; border-radius:999px; font-size:0.72rem; font-weight:600; background:{{ $bgStatus['bg'] }}; color:{{ $bgStatus['color'] }};">
                                    {{ $status }}
                                </span>
                            </td>
                ...
                <tfoot>
                    <tr style="border-top:2px solid #e5e7eb; background:#f9fafb;">
                        <td colspan="6" style="padding:10px 16px; font-weight:700; color:#374151;">Total Piutang</td>
                        <td style="padding:10px 16px; text-align:right; font-weight:700; color:#dc2626; font-size:1rem;">
